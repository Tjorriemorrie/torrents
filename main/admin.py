...
from main.constants import STATUS_NEW, STATUS_SKIPPED
...
@admin.register(TitleReady)
class TitleReadyAdmin(admin.ModelAdmin):
    ...
    change_list_template = 'main/titleready_change_list.html'
